...
def test_primary_key_duplicate(test_db):
    # Insert a row with a primary key
    new_row = {"emp_id": 106, "name": "Primary Key Test", "salary": 100000.00, "age": 33}
    test_db.insert_into("employees", new_row)
    
    # Attempt to insert another row with the same primary key
